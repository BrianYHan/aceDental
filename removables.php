...
<div class="container mainBlock">
	<h1 class="page-header">Dentures | Partials</h1>
	<div class="row">
		<div class="span3">
      <div class="well sidebar-nav">
        <ul class="nav nav-list">
          ...
          <li>
			...
			<img src="images/productImages/removables4.jpg" alt = "Nobel Machine" class="img-polaroid" >
		</div>
...
<div class="span10 ">
	...
	<p class="lead"><h5>REMOVABLE - ValplastFlexible Partial </h5><img src="images/productImages/removables.jpg" alt = "Flexible Partial" class="img-rounded pull-right img-polaroid">
	...
	<p><h5>REMOVABLE - Full Acrylic Denture</h5> <img src="images/productImages/removables2.jpg", alt ="Full Acrylic Denture " class="img-rounded pull-left img-polaroid">

	All Ace Dental Laboratory dentures are fabricated with the heat-cured system for high impact, natural looking, comfortable and precision fit. The dentures are fabricated using house, or premium brand teeth: TrubyteIPN, Portrait, Bioblendand Bioformcombined with most popular tooth shades (VitaClassic and Bioform.)
...
<p>The Trubyte IPN teeth are fabricated in a hardened plastic material and follow four face shapes (Square, Square Tapering, Tapering and Ovoid) in mould selection to create a natural look to the patient's smile. The teeth exhibit these vital attributes: Enamel translucency, Contrasting neck color, Color blending and Vital, natural appearance.</p>
	...
	<p><h5>REMOVABLE - Cast Partial Denture</h5>	<img src="images/productImages/removables3.jpg" alt ="Cast Partial Denture" class= "img-rounded pull-right img-polaroid">

	The experienced and certified Ace Dental Laboratory technicians can fabricate cast partials in Vitallium2000 Plus chrome cobalt alloy, the premium choice for partial denture metal frameworks or in variety of other metals depending on your patients' needs; these materials can be combined with various types of attachments and clasps for optimal aesthetics results.<p>
...
<p>Let Ace's expertise survey and design your partial denture cases, following your specifications and requirements helping to minimize your chairtime.</p>
	...
	<div class="row-fluid">
		<div class="span12">
	<small><small>IPS E.Max is a registered trade mark of Ivoclar Vivadent North America, Lava is registered trade marks of 3M ESPE. Procera is a registered trade mark of Noble Biocare. Ceramage is a registered trademark of Shofu, Inc. Captek is a registered trade mark of Precious Chemicals, Inc. Valplastis a registered trade mark of Valplast International Corporation. OPC 3G are registered trademarks of Pentron Clinical Corporation. Clip-On Veneers is a product of Shofu Dental Company.</small></small>
		</div>
	</div>
