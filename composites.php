...
<?php include("header.php"); ?>
	...
	<h1 class="page-header">Composites</h1>
			...
			<img src="images/productImages/composite2.jpg" alt = "Composite2" class= "img-rounded img-polaroid" >
		</div>
...
<p class="lead"><h5>COMPOSITE - Ceramage</h5>	<img src="images/productImages/composite.jpg" alt ="Composite1" class= "img-rounded pull-right img-polaroid">
