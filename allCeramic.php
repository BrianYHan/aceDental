...
<?php include("header.php"); ?>
	...
	<h1 class="page-header">Ceramic Crowns and Bridges</h1>
			...
			<img src="images/productImages/allCeramic3.jpg" alt= "Crowns/Bridges3" class= "img-rounded pull-right">
		</div>
...
<div class="row-fluid">
	<div class="span11">
	<p class="lead"><h5>ALL-CERAMIC - Feldspathic Veneers</h5>	<img src="images/productImages/allCeramic.jpg" alt = "Crowns/Bridges1" class= "img-rounded pull-right img-polaroid ">
...
<p>
By hand layering the porcelain, Ace Dental Laboratory certified and dedicated Ceramic artists create veneers of dynamic beauty and pearl-like translucency. Feldspathic veneers can be made as thin as 0.3 mm to 0.5 mm which requires far less tooth reduction than other veneering alternatives. These remarkable veneers are indicated for slight contour and color changes, and are available in bleach shades. Feldspathic veneers have a big impact on your patient's appearance by providing a vivid, natural, and lustrous smile!</p>


	<p class="lead"><h5>ALL-CERAMIC - IPS E.Max </h5>   	<img src="images/productImages/allCeramic4.jpeg" alt = "Crowns/Bridges4" class= "img-rounded pull-left img-polaroid " style="margin-right:15px;">                                                                                                     
<p>The new IPS E.Max Ivoclar Vivadent's patented lithium Disilicate material is truly a revolution for the dental industry. Never before has a material been able to combine high strength, high esthetics and ease of use into one product, until now.</p>
...
<p>The opalescence, translucency and light diffusion properties of IPS E.Max Lithium Dislicate were all designed to replicate natural tooth structure for beauty and undetectable restorations.</p>


	<p class="lead"><h5>ALL-CERAMIC - 3G</h5>	<img src="images/productImages/allCeramic5.jpg", alt = "Crowns/Bridges5" class= "img-rounded pull-right img-polaroid" style="margin-left:15px;">
		<p>OPC 3GTM Porcelain is a pressable ceramic system that delivers consistent bridges which are reliable and durable. The needle-like crystalline structure is made up of a lithium Disilicate, glass ceramic material which inhibits crack propagation. The crystal free overlay porcelain is kinder to opposing dentition and polishes to a glossy high shine. Recommended for three unit anterior bridges or anterior/posterior single unit applications. 3G Porcelain is twice the strength of the previous generation of pressable ceramics.</p>
